...
export const bottomSheetDrawerTheme: DeepPartial<FlowbiteDrawerTheme> = {
   root: {
      base: 'fixed z-40 overflow-y-auto p-4 transition-transform bg-white text-white flex flex-col',
   },
   header: {
      inner: {
         titleText: 'mb-4 text-xl inline-flex items-center text-base font-semibold text-black',
         closeButton:
