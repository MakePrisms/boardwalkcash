...
import { Text, View, styled } from '@tamagui/web';
import { useState } from 'react';
import { TealHeading } from '~/components/teal-heading';
import { TestingButton } from '~/components/testing-button';

export const meta: MetaFunction = () => {
  return [
    { title: 'Boardwalk with Remix & Tamagui' },
    {
      name: 'description',
      content: 'Welcome to Boardwalk!',
    },
  ];
};
  ...
  return (
    ...
    >
      ...
      <Section>
        ...
        <Link to="/test">To other page</Link>
        <TestingButton>No action button</TestingButton>
        <TealHeading>Testing heading</TealHeading>
      </Section>
      <View
        tag="footer"
        padding="$large"
