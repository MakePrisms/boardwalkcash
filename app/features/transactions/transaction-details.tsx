...
export function TransactionDetails({
  ...
  const isReclaimInProgress = isReversing;
  const isWaitingForStateUpdate =
    isReclaimed && transaction.state !== 'REVERSED';

  const shouldShowReclaimButton = canReclaim || isWaitingForStateUpdate;
  const isReclaimButtonLoading = isReclaimInProgress || isWaitingForStateUpdate;
