...
export function TransactionDetails({
  ...
  const rates = { 'BTC-USD': 10000, 'USD-BTC': 0.0001 };
  const convertedAmount = amount.convert('BTC', rates['USD-BTC']);
    ...
    <PageContent className="flex w-full max-w-md flex-col justify-between gap-6">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex items-center gap-2 font-bold text-2xl">
          ...
          <MoneyDisplay money={amount} unit="usd" />
        </div>
        ...
        {transaction.token && (
          <div className="flex w-full flex-col gap-4">
            <div className="flex justify-between gap-2">
              <Button
                variant={isTokenClaimed ? 'default' : 'destructive'}
                className="flex-1"
              >
                {isTokenClaimed ? (
                  <>
