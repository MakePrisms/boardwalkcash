...
import { useTrackNotificationsReadStatus } from '../notifications/notification-hooks';
...
const Wallet = ({ children }: PropsWithChildren) => {
  ...
  const notificationsSubscription = useTrackNotificationsReadStatus();
  ...
  if (
    ...
    notificationsSubscription === 'subscribing' ||
