...
export const PayBolt11Confirmation = ({
  ...
  const { status: quoteStatus } = useTrackCashuSendQuote({
    ...
    onPending: () => {
      // TODO: Can we update the transaction-details page to show all the needed data for a send?
      // We are using it for  pending receives now. It would be nice to make the transaction-details
      // page accuratley show all states and fees.
