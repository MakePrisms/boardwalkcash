...
export const completeClearAuthFlow = async (): Promise<ClearAuthSession> => {
  ...
  // Store the redirect_uri in sessionStorage during startClearAuthFlow to ensure consistency
  // TODO: this was a hack to fix something I don't remember, shouldn't be needed
  const redirect_uri =
    sessionStorage.getItem('oidc_redirect_uri') ||
