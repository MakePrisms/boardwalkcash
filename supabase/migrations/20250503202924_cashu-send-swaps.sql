...
begin
    ...
    if v_updated_swap is null then
        raise exception 'Concurrency error: Swap % was modified by another transaction. Expected version %, but found different one.', p_swap_id, p_swap_version;
    end if;
